#ifndef ARCH_NAV__CORE__MODEL__VEHICLE__BEHAVIOR_SUBJECT_HPP_
#define ARCH_NAV__CORE__MODEL__VEHICLE__BEHAVIOR_SUBJECT_HPP_
...
#endif  // ARCH_NAV__CORE__MODEL__VEHICLE__BEHAVIOR_SUBJECT_HPP_
